...
final class AddStyleView: BaseView {
    
    let collectionView: UICollectionView = {
        let view = UICollectionView(frame: .zero, collectionViewLayout: collectionViewLayout())
        view.register(AddStyleCollectionViewCell.self, forCellWithReuseIdentifier: AddStyleCollectionViewCell.reuseIdentifier)
